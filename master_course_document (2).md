...
* **Period 1 (In-Class): Environment Setup & Database Basics** *(Difficulty: 2/5 - Technical setup can have hiccups)*
  ...
  * **Resource Guidance:** Watch the [Database Architecture and Installation video segment](https://www.youtube.com/watch?v=qw--VYLpxG4&t=0s).
...
* **Period 2 (In-Class): The `SELECT` Statement & Basic Formatting** *(Difficulty: 1/5 - Very straightforward syntax)*
  ...
  * **Resource Guidance:** Review the [PostgreSQL SELECT syntax](https://neon.com/postgresql/tutorial/select) for writing basic queries.
...
* **Periods 3 & 4 (Independent): Data Exploration Lab**
  ...
  * *150-Minute Activity Breakdown:*
    ...
    * **Environment & Navigation (45 mins):** *(Difficulty: 2/5)* Configure the PostgreSQL connection. Identify the target schema and document primary keys without writing code. **Resource:** Review the [DBeaver/GUI Setup video segment](https://www.youtube.com/watch?v=qw--VYLpxG4&t=2100s).

    * **Guided Queries (45 mins):** *(Difficulty: 1/5)* Write 15-20 foundational queries (e.g., retrieving full names, math operations). **Resource:** Reference the [Column Aliases guide](https://neon.com/postgresql/tutorial/column-alias) for output formatting.
...
* **Period 1 (In-Class): The `WHERE` Clause** *(Difficulty: 2/5)*
  ...
  * **Resource Guidance:** Review the [WHERE clause](https://neon.com/postgresql/tutorial/where) and [LIKE operator](https://neon.com/postgresql/tutorial/like) documentation.
...
* **Period 2 (In-Class): Advanced Filtering & Sorting** *(Difficulty: 3/5 - Boolean logic is tricky for some)*
  ...
  * **Resource Guidance:** Review the [AND/OR operators](https://neon.com/postgresql/tutorial/and) and [ORDER BY clause](https://neon.com/postgresql/tutorial/order-by).
...
* **Periods 3 & 4 (Independent): Targeted Retrieval Lab**
  ...
  * *150-Minute Activity Breakdown:*
    ...
    * **Business Reporting Challenge (60 mins):** *(Difficulty: 3/5)* Produce specific, ordered lists requiring combination of logic (e.g., top 10 most expensive items currently in stock). **Resource:** Keep the [PostgreSQL WHERE documentation](https://neon.com/postgresql/tutorial/where) open for syntax reference during the challenge.
...
* **Period 1 (In-Class): Relational Concepts & Inner Joins** *(Difficulty: 3/5 - First major conceptual hurdle)*
  ...
  * **Resource Guidance:** Watch the [Inner Joins and Venn Diagrams video segment](https://www.youtube.com/watch?v=qw--VYLpxG4&t=5400s) to visualize row-matching concepts.
...
* **Period 2 (In-Class): Outer Joins & Complex Joins** *(Difficulty: 4/5)*
  ...
  * **Resource Guidance:** Watch the [Outer and Complex Joins video segment](https://www.youtube.com/watch?v=qw--VYLpxG4&t=6900s).
...
* **Periods 3 & 4 (Independent): Data Integration Lab**
  ...
  * *150-Minute Activity Breakdown:*
    ...
    * **Join Mechanics (60 mins):** *(Difficulty: 4/5)* Write 4-table joins. **Resource:** Reference the [PostgreSQL Joins guide](https://neon.com/postgresql/tutorial/joins) for exact `ON`/`USING` clause syntax.
...
* **Period 1 (In-Class): Aggregation & Grouping** *(Difficulty: 3/5)*
  ...
  * **Resource Guidance:** Review the [GROUP BY](https://neon.com/postgresql/tutorial/group-by) and [HAVING](https://neon.com/postgresql/tutorial/having) clauses.
...
* **Period 2 (In-Class): Set Operations & Basic Pivoting** *(Difficulty: 5/5 - Conditional aggregation is highly advanced for intro level)*
  ...
  * **Resource Guidance:** Review [Set Operations (UNION)](https://neon.com/postgresql/tutorial/union) to understand alignment rules.
...
* **Periods 3 & 4 (Independent): Business Reporting Lab**
  ...
  * *150-Minute Activity Breakdown:*
    ...
    * **Summary Reports (45 mins):** *(Difficulty: 3/5)* Use `GROUP BY` and `HAVING`. **Resource:** Reference [PostgreSQL Aggregate Functions](https://neon.com/postgresql/tutorial/aggregate-functions) during this section.
...
* **Period 1 (In-Class): DML & The Art of Validation** *(Difficulty: 3/5)*
  ...
  * **Resource Guidance:** Review the syntax for [INSERT](https://neon.com/postgresql/tutorial/insert), [UPDATE](https://neon.com/postgresql/tutorial/update), and [DELETE](https://neon.com/postgresql/tutorial/delete) to ensure strict adherence.
...
* **Periods 3 & 4 (Independent): Data Cleanup Lab**
  ...
  * *150-Minute Activity Breakdown:*
    ...
    * **The Safe Update Protocol (60 mins):** *(Difficulty: 4/5)* Submit the `SELECT` query used to identify target rows, the `UPDATE` statement, and the post-execution verification query. **Resource:** Keep the [Data Modification Reference (UPDATE)](https://neon.com/postgresql/tutorial/update) open to prevent catastrophic errors.
...
* **Period 1 (In-Class): Subqueries & Common Table Expressions (CTEs)** *(Difficulty: 4/5)*
  ...
  * **Resource Guidance:** Review [Common Table Expressions (CTEs)](https://neon.com/postgresql/tutorial/cte).
...
* **Period 2 (In-Class): Window Functions** *(Difficulty: 5/5 - Heavy conceptual abstraction)*
  ...
  * **Resource Guidance:** Review [Window Functions](https://neon.com/postgresql/tutorial/window-functions).
...
* **Periods 3 & 4 (Independent): Advanced Analytics Lab**
  ...
  * *150-Minute Activity Breakdown:*
    ...
    * **Ranking & Deduplication (45 mins):** *(Difficulty: 4/5)* Use `ROW_NUMBER()` and `PARTITION BY` to rank items and filter out duplicates. **Resource:** Review [Window Function Examples](https://neon.com/postgresql/tutorial/window-functions) to complete the ranking exercises.
...
* **Period 1 (In-Class): Design & Integrity** *(Difficulty: 4/5 - Normalization is highly theoretical)*
  ...
  * **Resource Guidance:** Watch the [Database Design, Primary/Foreign Keys, and Constraints video segment](https://www.youtube.com/watch?v=qw--VYLpxG4&t=10800s).
...
* **Period 2 (In-Class): Custom Database Objects & Intro to Data Warehousing** *(Difficulty: 3/5)*
  ...
  * **Resource Guidance:** Review [PostgreSQL Views](https://neon.com/postgresql/tutorial/views).
...
* **Periods 3 & 4 (Independent): Schema Design Lab**
  ...
  * *150-Minute Activity Breakdown:*
    ...
    * **DDL Scripting (60 mins):** *(Difficulty: 3/5 - Easy concepts, syntax-heavy)* Write the exact `CREATE TABLE` scripts with correct constraints. **Resource:** Review [Data Types](https://neon.com/postgresql/tutorial/data-types) and [CREATE TABLE](https://neon.com/postgresql/tutorial/create-table).
...
* **Period 1 (In-Class): Performance & Indexing Basics** *(Difficulty: 3/5)*
  ...
  * **Resource Guidance:** Review [PostgreSQL Indexes](https://neon.com/postgresql/tutorial/indexes).
